const context = {
  title: 'Welcome to Beat Jungle',
  body: 'Beat Jungle is a budding musical storefront with a mission to share the joy of music. These magnificent auditory tools are designed with musical creators, like you, in mind. Hobbyists, beginners, and experts alike can appreciate the resplendent sounds supplied by each and every instrument we carry. Join us in delivering the euphoric vibrations of melodia to the citizens of the world!',
  instruments: [
    {
      image: 'public/images/electronic-keyboard.png',
    ...
    {
      image: 'public/images/electric-guitar.png',
    ...
    {
      image: 'public/images/bass-guitar.png',
      name: 'Bass Guitar',
    ...
    {
      image: 'public/images/violin.png',
      name: 'Violin',
...
// a template using the Handlebars.compile() method
const template = Handlebars.compile(templateSource);
// template will accept an object and
// use the properties of the object to fill in a Handlebars template
